...
from transformers import BertTokenizer, BertForMaskedLM, BertConfig, ElectraForMaskedLM, ElectraForPreTraining
from model.bert_layers import Bert_For_Att_output_MLM
    ...
    for epoch in range(args.epochs):
        ...
        for file in folders:
            ...
            for batch in tqdm(train_dataloader, ncols=100):
                ...
                if iters % 100000 == 0:
                    PATH = './save_model/bert/%s_%s_%s_%d_clean_originalCCL.pt' % (
                        str(args.pretrained), str(step), str(args.random_seed), int(curriculum_num))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_path", default='/home/user3/data/pure_huggingface/CCL_clean_corpus_final_v220325/', type = str)
    ...
    # model_save_path = "/home/user3/CCL/saved_model/bert/bert-base_uncased_800000_2106_2_clean.pt"
    #
